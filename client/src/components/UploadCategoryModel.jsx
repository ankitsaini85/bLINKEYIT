...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    const handleUploadCategoryImage = async(e)=>{
        ...
        try {
            ...
            // Guard: ensure upload succeeded and payload exists
            const uploadedUrl = ImageResponse?.data?.secure_url 
                || ImageResponse?.data?.url 
                || ImageResponse?.secure_url 
                || ImageResponse?.url
            if(!ImageResponse?.success || !uploadedUrl){
                console.warn('Upload response missing url', ImageResponse)
                toast.error(ImageResponse?.message || "Image upload failed. Please login again and retry.")
                return
            }
